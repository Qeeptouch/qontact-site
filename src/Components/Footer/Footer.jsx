                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                            <div className="single-footer-widget">
                                ...
                                <div className="footer-content">
                                    <p>
                                        Ayudamos a las empresas a controlar la asistencia de manera simple, ágil y segura, escribinos! 
                                    </p>
                                    ...
                                    <div className="info">
                                        <div className="icon"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="23"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#EE5F3C" strokeWidth="2" strokeLinecap="round"
                                                    strokeLinejoin="round" />
                                                <path d="M20.1667 6L11 12.4167L1.83337 6" stroke="#EE5F3C" strokeWidth="2"
                ...
                <div className="container">
                    <div className="footer-wrapper d-flex align-items-center justify-content-between">
                        <p className="wow fadeInLeft" data-wow-delay=".3s">
                            Copyright © Qontact 2025 All rights
                        </p>
                        <ul className="social-links" data-wow-delay=".5s">
                            {/* <li> <a href="#"><i className="bi bi-facebook"></i></a> </li>
                            <li> <a href="#"><i className="bi bi-twitter"></i></a> </li> */}
                            <li> <a href="https://www.linkedin.com/company/qontactapp/"><i className="bi bi-linkedin"></i></a> </li>
                            <li> <a href="https://www.instagram.com/qontact_app/"><i className="bi bi-instagram"></i></a> </li>
                        </ul>
                    </div>
                </div>
            </div>
